  ...
  Item { 
    ...
    property int modeCount:plasmoid.configuration.modeCount
    ...
    height: ((theme.defaultFont.pixelSize * 1.5) * plasmoid.configuration.modeCount) + 10
  
      Component.onCompleted: {
        xrxData.connectedSources = xrxDataSource;
        fullRoot.height = ((theme.defaultFont.pixelSize * 1.5) * plasmoid.configuration.modeCount) + 10
      }
    ...
    Rectangle {
      ...
      width: theme.defaultFont.pixelSize * 7.6
      //height: ((theme.defaultFont.pixelSize * 1.5) * modeCount) + 10
      height: parentHeight
